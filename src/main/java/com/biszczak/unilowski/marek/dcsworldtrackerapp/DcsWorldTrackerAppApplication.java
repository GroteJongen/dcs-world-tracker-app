...
public class DcsWorldTrackerAppApplication {
    ...
    public CommandLineRunner dataInitializer(MissionRepository missionRepository, PlayerRepository playerRepository) {
        return (args) -> {
            ...
            missionRepository.save(new Mission(1, "Andrzej leci jak szalooony", "Brak opisu", Collections.singletonList(new Statistics(1, 1, 1, 100, 2, 0, 3, true, LocalDateTime.of(2021, 1, 11, 10, 11, 12)))));
            missionRepository.save(new Mission(2, "Andrzej dolatuje do lotniska", "Brak opisu", Collections.singletonList((new Statistics(2, 2, 1, 200, 5, 2, 1, false, LocalDateTime.of(2021, 2, 12, 12, 13, 14))))));
            missionRepository.save(new Mission(3, "Andrzej zladowal", "Brak opisu", Collections.singletonList(new Statistics(3, 3, 1, 300, 6, 1, 5, true, LocalDateTime.of(2021, 1, 15, 13, 14, 16)))));
            missionRepository.save(new Mission(4, "Andrzej andrzej jedzie do hangaru", "Brak opisu", Collections.singletonList(new Statistics(4, 3, 1, 600, 6, 2, 5, true, LocalDateTime.of(2021, 1, 16, 13, 4, 16)))));
