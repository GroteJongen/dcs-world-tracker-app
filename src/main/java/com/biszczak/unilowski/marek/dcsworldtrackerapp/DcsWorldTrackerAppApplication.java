...
public class DcsWorldTrackerAppApplication {
	...
	public CommandLineRunner dataInitializer(MissionRepository missionRepository, PlayerRepository playerRepository, StatisticsRepository statisticsRepository){
		return (args) -> {
			...
			missionRepository.save(new Mission(1,"Andrzej leci jak szalooony","Brak opisu"));
			missionRepository.save(new Mission(2,"Andrzej dolatuje do lotniska","Brak opisu"));
			missionRepository.save(new Mission(3,"Andrzej zladowal","Brak opisu"));

			statisticsRepository.save(new Statistics(1,1,1,100,2,3,true));
			statisticsRepository.save(new Statistics(2,2,1,200,5,1,false));
			statisticsRepository.save(new Statistics(3,3,1,300,6,5,true));
		};
	}
}
